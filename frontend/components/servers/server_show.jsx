    ...
    useEffect(() => {
        ...
        return (
            <div className="channel-bar">
                ...
                <br/>
                <div className="create-channel" onClick={() => setShowCreateModal(!showCreateModal)}>Add Channel</div>
                <div
                ...
                <div>
                    <Modal
                        ...
                        onRequestClose={() => setShowCreateModal(!showCreateModal)}
                        ariaHideApp={false}
                        style={{
                            content: {
                                top: '50%',
                    ...
                    >
                        <CreateChannelFormContainer server={server} closeModal={() => setShowCreateModal(!showCreateModal)} />
                    </Modal>
                </div>
                <br/>
                ...
                <ul className="channels">
                    {channels.map((channel) => (
                        <li key={channel.id}>
                            <button className="channel-link" onClick={() => history.push(`/servers/${server.id}/${channel.id}`)}>#{channel.channel_name}</button>
                        </li>
                    ))}
                </ul>
                <div>
